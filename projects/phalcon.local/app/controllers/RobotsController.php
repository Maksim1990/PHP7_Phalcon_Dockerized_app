...
//        $this->view->setVar('robots', $robots);
        ...
        $this->view->disable();
        $coordinates="53.379046606878724,28.604783787259834";
...
<h2>Tables</h2>
<h3>CSS Styles</h3>
<p>The CSS properties for tables and cells is increased over that in html2fpdf. It includes
recognition of THEAD, TFOOT and TH.<br />See below for other facilities such as autosizing, and
rotation.</p>
...
<table align="left" style="border: 1px solid #880000;margin-bottom:50px; font-family: Mono; font-size: 7pt; "
class="widecells">
<tbody><tr><td>Row 1</td><td>This is data</td><td>This is data</td></tr>
...
<p>The style sheet used for these examples shows some of the table styles I use on my website. The
property  defined by a border-type definition e.g. "1px solid #880000" puts a border at
the top and bottom of the table, and also below a header row (thead) if defined. Note also that
&lt;thead&gt; will automatically turn on the header-repeat i.e. reproduce the header row at the top of
each page.</p>
<p>bpmTopic Class</p>
...
<li>Item 3</li>This table has padding-left
<li>Another Item</li>
<li>Subitem
<ol>
<li>Level 3 subitem</li>
...
dictum. Maecenas consectetuer eros quis massa. Mauris semper velit vehicula purus. Duis lacus. Aenean
pretium consectetuer mauris. Ut purus sem, consequat ut, fermentum sit amet, ornare sit amet, ipsum.
Donec non nunc. Maecenas fringilla. Curabitur libero. In dui massa, malesuada sit amet, hendrerit
vitae, viverra nec, tortor. Donec varius. Ut ut dolor et tellus adipiscing adipiscing.</td>
</tr>
</tbody></table>
...
<td width="40%">
<img src="http://www.webphoria.co.uk/wp-content/uploads/2014/06/logo-nanostate.jpg" width="126px" />
</td>
<td width="40%" align="center"><img src="http://www.webphoria.co.uk/wp-content/uploads/2014/06/logo-nanostate.jpg" width="126px" /></td>
<td width="20%" style="text-align: right;"><span style="font-weight: bold;">{DATE j-m-Y}</span></td>
</tr></table>
';
        ...
        $footer='
<table width="100%" style="vertical-align: bottom; font-family:
serif; font-size: 9pt; color: #000088;">
<tr>
    <td width="80%">
        <img src="https://www.angulodesign.com/wp-content/uploads/2017/05/lg-angulodesign-2017-300x100px-azul-transp.png" width="100" height="50" alt="">
    </td>
